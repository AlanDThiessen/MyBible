...
(function() {
    ...
    angular.module('BibleDB', ['ionic'])
        .factory('BibleDB', BibleDB);

    BibleDB.$inject = ['$rootScope', '$window'];

    function BibleDB($rootScope, $window) {
        var myBible = {};
        var DB_NAME = "web.db";
        var db;
        var books = [];
        ...
        myBible.GetBooks = function () {
            return books;
        };


        myBible.GetPassage = function () {
            return passage;
        };
        ...
        myBible.SelectPassage = function (division, book, chapter) {
            ...
            if (foundBook.found) {
                ...
                passage.chapter = chapter;
                UpdateLocalStorage();
                $rootScope.$broadcast(myBible.events.PASSAGE_SELECTED, {
                    index: passage.index,
